...
public class FavoritesProvider extends ContentProvider {
    ...
    public static final String PROVIDER_TABLE = MoviesContract.FavoriteEntry.TABLE_NAME;
    ...
    public Cursor query(Uri uri, String[] projection, String selection, String[] selectionArgs, String sortOrder) {
        ...
        switch (uriMatcher.match(uri)) {
            case MOVIES:
                ...
                break;
            case MOVIE_ID:
                queryBuilder.appendWhere(MoviesContract.FavoriteEntry.COLUMN_MOVIE_ID + " = " + uri.getPathSegments().get(1));
                cursor = queryBuilder.query(sqLiteDatabase, projection, selection, selectionArgs, null, null, sortOrder);
                break;
            case MOVIE_COUNT:
